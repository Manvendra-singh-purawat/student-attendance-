...
return(
  ...
  <TouchableOpacity
   ...
   }}> 1: Shivam: {this.state.sammy} ({this.state.sdate}) </TouchableOpacity>
   ...
   }}> 2: Taha: {this.state.kevin} ({this.state.kdate}) </TouchableOpacity>
   ...
   }}> 3: Arunansh : {this.state.mike} ({this.state.mdate}) </TouchableOpacity>
   ...
   }}> 4: Dhiraj: {this.state.emma} ({this.state.edate}) </TouchableOpacity>
