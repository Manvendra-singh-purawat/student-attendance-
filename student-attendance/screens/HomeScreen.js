...
date: today
  ...
  render(){
    return(
      ...
      <Text style={styles.likeText}>1: Shivam</Text>
      <TouchableOpacity
      style={[styles.button, {backgroundColor:"red"}]}
...
<Text style={styles.likeText}>2: Taha</Text>
      <TouchableOpacity
      style={[styles.button, {backgroundColor:"red"}]}
...
<Text style={styles.likeText}>3: Arunansh </Text>
      <TouchableOpacity
      style={[styles.button, {backgroundColor:"red"}]}
...
<Text style={styles.likeText}>4: Dhiraj </Text>
      <TouchableOpacity
